...
MM.main = function (config) {
	...
	jQuery(function () {
		var activityLog = new MM.ActivityLog(10000),
			...
			pdfPublishingConfigGenerator = new MM.AjaxPublishingConfigGenerator('http://' + config.pdfBucket + '.s3.amazonaws.com/', 'layoutPublishingConfig?format=pdf', undefined, goldLicenseManager.goldLicenseIdentifiers),
